...
<body>
    ...
    <div class="container main-container">
        <h1 class="heading">Data Film</h1>

        <div class="d-flex justify-content-end p-3">
            <a href="add_films.php" class="btn btn-success btn-custom"><i class="fas fa-plus"></i> Tambah Film</a>
        </div>
                    ...
                    if (count($film) > 0) {
                        foreach ($film as $index => $data) {
                            echo "<tr>
                                    ...
                                    <td>" . htmlspecialchars($data['release_schedule']) . "</td>
                                    <td>
                                        <a href='update_film.php?id=" . htmlspecialchars($data['film_id']) . "' class='btn btn-warning btn-sm'><i class='fas fa-edit'></i> Edit</a>
                                        <a href='hapus_film.php?id=" . htmlspecialchars($data['film_id']) . "' class='btn btn-danger btn-sm' onclick=\"return confirm('Apakah Anda yakin ingin menghapus film ini?')\"><i class='fas fa-trash'></i> Hapus</a>
                                    </td>
                                  </tr>";
                        }
                    } else {
