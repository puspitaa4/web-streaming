...
if (isset($_POST['Register'])) {
    ...
    $sql = "INSERT INTO users (username, email, password, role, status, name, birthdate) VALUES (?, ?, ?, 'user', 'inactive', '$fullname', '$date')";
            ...
            <form action="" method="post">
                <div class="mb-3">
                    ...
                    <input
                        ...
                        autocomplete="off"
                    />
                    <label class="input-text-label" for="username">Username</label>
                    </div>
                </div>
                <br>
                <div class="mb-3">
                    ...
                    <input
                        ...
                        autocomplete="off"
                    />
                    <label class="input-text-label" for="fullname">Fullname</label>
                    </div>
                </div>
                <br>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input
                        ...
                        autocomplete="off"
                    />
                    <label class="input-text-label" for="date">Birthdate</label>
                    </div>
                </div>
                <br>
                <div class="mb-3">
                ...
                <div class="button">
                        ...
                        <button class="bt w-50" type="submit" name="Register">Register</button><br>
                </div>
