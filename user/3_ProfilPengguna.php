            ...
            <div class="profile-layout">
                ...
                <form action="" method="POST" class="profile-form" id="profile-form">
                    <div class="form-group">
                        ...
                        <input type="text" id="fullname" name="fullname" value="<?php echo $user['name']?>" disabled>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" id="birth_date" name="birth_date" value="<?php echo $user['birthdate']?>" disabled>
                    </div>
